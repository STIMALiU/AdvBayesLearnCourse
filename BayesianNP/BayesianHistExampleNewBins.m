...
bin = linspace(min(data),max(data),10);
...
print PosteriorAlpha1NewBins -depsc2
...
print PosteriorAlpha10NewBins -depsc2
...
print PosteriorAlpha100NewBins -depsc2
...
print PosteriorAlpha1000NewBins -depsc2